...
for test_case in Test_cases:
    ...
    plt.xticks(Threads)
    plt.title(f"Parallel Linked List Execution Times - Test Case {Test_cases.index(test_case)}")
    plt.xlabel("Number of Threads")
    plt.ylabel("Execution Time (ms)")
    plt.grid()
    plt.savefig(f"parallel_linked_list_execution_times_test_case_{Test_cases.index(test_case)}.png")
